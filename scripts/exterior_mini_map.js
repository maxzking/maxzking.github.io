...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateImages() {
        const selectedRoom1 = document.querySelector('input[name="Room"][value="interior"]').checked;
        const selectedRoom2 = document.querySelector('input[name="Room"][value="receive-room-2"]').checked;
        const selectedSourceRoom = document.querySelector('input[name="Room"][value="exterior"]').checked;
        ...
        // Update Room 1 Image
        const room1Image = document.querySelector('.img-interior');
        ...
        const sourceImage = document.querySelector('.img-exterior');
